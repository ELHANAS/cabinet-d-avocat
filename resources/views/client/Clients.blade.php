        ...
        <form class="form-inline">
            <div class="row p-0  d-flex justify-content-around">
                <div class="col-4  text-start" >
                    <a href="{{route('create-clients')}}" class="btn w-25" style="color:{{\App\Models\Color::getColors()->textBtn}};background: {{\App\Models\Color::getColors()->bgBtn}}">
                            ...
                            @if(!@empty($data))
                                @foreach($data as $info)
                                    <tr>
                                        ...
                                        <td>{{$info->ville}}</td>
                                        <td>
                                            <a href="{{route('edit-clients', $info->id)}}" class="btn " style="background:     {{\App\Models\Color::getColors()->bgBtn}};color: {{\App\Models\Color::getColors()->textBtn}}">
                                            ...
                                            <a href="{{route('delet-clients', $info->id)}}" onclick="return confirm('êtes-vous sûr de vouloir supprimer le client {{$info->name}} ')" class=" btn" style="color: {{\App\Models\Color::getColors()->textBtn}};background:     {{\App\Models\Color::getColors()->bgBtn}};">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
                                                    <path d="M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1H2.5zm3 4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5zM8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7A.5.5 0 0 1 8 5zm3 .5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 1 0z"/>
                                                </svg></a>
                                            <a href="{{route('show-client', $info->id)}}"  class=" btn" style="background:     {{\App\Models\Color::getColors()->bgBtn}};color: {{\App\Models\Color::getColors()->textBtn}}">
