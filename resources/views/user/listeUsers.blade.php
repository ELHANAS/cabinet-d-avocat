                ...
                @foreach($users as $user)
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn  " style="background: {{\App\Models\Color::getColors()->bgBtn}};color: {{\App\Models\Color::getColors()->textBtn}} "  onclick="return confirm('êtes-vous sûr de vouloir supprimer l utilisateur {{$user->name}}')" href="{{route("user.destroy",["id"=>$user->id])}}">
