...
@section("content")
    ...
    <form class="row" enctype="multipart/form-data" action="/client/store">
        <div class="col-6">
            <div class="form-group row p-3">
                <label class="col" for="nom">Nom :</label>
                <input  type="text" class="form-control  col col" id="nom" aria-describedby="emailHelp" name="nom" value="{{old("nom")}}" placeholder="Nom">
                @error("nom")
            ...
            <div class="form-group  row  p-3">
                ...
                <input type="text" name="userName" class="form-control col col" id="userName" value="{{old("userName")}}" placeholder="entrer your user Name ...">
                @error("userName")
                <small  class="ms-3 form-text text-danger">{{$message}}</small>
                @enderror
            </div>
        ...
        <div class="col-6 ">
            <div class="form-group row  p-3">
                ...
                <input type="text" class="form-control col" id="prenom"  name="prenom" value="{{old("prenom")}}" placeholder="entrer your prénom ..">
                @error("prenom")
                <small  class="ms-3 form-text text-danger">{{$message}}</small>
                @enderror
            </div>
