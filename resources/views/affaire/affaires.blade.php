        ...
        <table class="table " style="color:{{\App\Models\Color::getColors()->textMain}};font-size: 15px   ">
            ...
            <tr>
                ...
                <td  >
                    ...
                    <a href="{{route("affaire.destory",$info->id)}}" onclick="return confirm('êtes-vous sûr de vouloir supprimer la affaire {{$info->name}}')" class=" btn" style="background: {{\App\Models\Color::getColors()->bgBtn}};;color: {{\App\Models\Color::getColors()->textBtn}}">
